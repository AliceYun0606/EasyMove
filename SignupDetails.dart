              ...
              onTap:(){
                if (_formKey.currentState!.validate() && front_ic_image != null && back_ic_image != null) {
                  Navigator.push(context,
                    MaterialPageRoute(builder:(context) => SignupVehicle(fullname_value.text,ic_value.text,mobilenumber_value.text,emergencycontact_value.text,employment_type_value,regionMap[region_value]!,front_ic_image,back_ic_image,username_value.text,password_value.text )),
                  );
                }
              },
